...
class TransOut extends CI_Controller {
	...
	public function __construct()
	{
		...
		// AMBIL DATA
		$this->load->model('transout_model');
		$this->load->model('products_model');
		
	}
	public function index()
	{	
		$transaction = $this->transout_model->listing();
		$category = 'transOut';

		$data = array ( 'title'			=>	'Transaction Out',
		...
		$valid->set_rules('stock', 'Stock', 'required',
			array ( 'required'		=> 	'%s harus diisi!'));
					...
					if($valid->run()==FALSE){
                        ...
                        $data = array ( 'title'		=>	'Tambah Transaction Open',
										'category'	=>	$category,
                                        'products' 	=>	$products,
	...
	{		
        ...
        $transaction = $this->transout_model->detail($t_id);
		$category = 'transOut';
        $AmbilManufacture = $this->transout_model->AmbilManufacture($t_id);
	...
	public function delete($t_id)
	{
			...
			$this->transout_model->delete($data);
