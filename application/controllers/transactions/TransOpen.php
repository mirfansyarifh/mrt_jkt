...
class TransOpen extends CI_Controller {
	...
	public function __construct()
	{
		...
		// AMBIL DATA
		$this->load->model('transopen_model');
		$this->load->model('products_model');
		
	}
	public function index()
	{	
		$transaction = $this->transopen_model->listing();
		$category = 'transOpen';

		$data = array ( 'title'			=>	'Transaction Open',
	...
	public function delete($t_id)
	{
			...
			$this->transopen_model->delete($data);
